...
const Proudacts = ({pro,order,deforder,setLoveprouduct,Loveprouduct,width}) => {
  return (
  <>
  <div className='flex w-full  justify-between items-center mt-20 mb-10 '>
     <h2 className={`${width>600?'text-lg':'text-sm' }`}>Trinding Now</h2>
     <p className={`${width>600?'text-lg':'text-sm' }   text-blue-500  font-semibold`}><Link to={'/ALLPROUDACT'}>view all prouducts</Link></p>
  </div>
